  ...
  return (
    <section>
      <Helmet>
        ...
        <meta property="og:url" content='https://veerin-bajracharya.vercel.app/about' />
        ...
        <meta name="twitter:url" content="https://veerin-bajracharya.vercel.app/about" />
      ...
      <section className="xs:px-5 md:px-12 md:max-w-screen-xl md:py-8 md:my-5 md:mx-auto">
        ...
        <ul className="relative border-l-1 border-gray-300 mt-12" data-aos="fade-down" data-aos-duration="4000">
          ...
          <li className="mb-10 ml-4">
            ...
            <p className="xs:text-sm md:text-lg font-normal tracking-wide leading-6">Hey! Myself Veerin Bajracharya, a BCA student and curious web developer. I enjoy turning ideas into clean and responsive websites. I love experimenting with front-end stuffs like
              <span className='font-bold text-blue-400'><Link to='https://tailwindcss.com/'> Tailwind CSS</Link></span>,
              <span className='font-bold text-blue-400'><Link to='https://react.dev/'> React</Link></span>, and exploring various front-end libraries to include something new on projects. Also keeping myself engaging with back-end framework <span className='font-bold text-blue-400'><Link to='https://laravel.com/'> Laravel</Link></span>. I may be a beginner, but I'm constantly working, learning and pushing myself toward becoming a skilled developer as well as teacher. I do enjoy teaching others as well, with what I have learnt. I began my teaching process with giving tuitions and teaching my juniors in college too.</p>
          </li>

          <li className="mb-10 ml-4">
            <div className="absolute w-3 h-3 bg-gray-950 border-3 rounded-full -left-1.5"></div>
            <h2 className="xs:text-xl md:text-3xl font-bold mb-5 font-[outfit]">Personal Interests</h2>
