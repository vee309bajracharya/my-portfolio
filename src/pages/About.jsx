    ...
    <section>
      ...
      <section className="xs:px-5 md:px-12 md:max-w-screen-xl md:py-8 md:my-5 md:mx-auto">
        ...
        <ul className="relative border-l-1 border-gray-300 ml-4 mt-12">
          ...
          <li className="mb-10 ml-4">
            <div className="absolute w-3 h-3 bg-gray-950 border-3 rounded-full -left-1.5"></div>
            <h2 className="text-3xl font-bold mb-5 font-[outfit]">My Tech Learning Journey</h2>
            <PolarAreaChart />
          </li>
          ...
          <li className="mb-10 ml-4">
            <div className="absolute w-3 h-3 bg-gray-950 border-3 rounded-full -left-1.5"></div>
            <h2 className="text-3xl font-bold mb-5 font-[outfit]">Certificates</h2>
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}>
          <a href='/my-portfolio/projects' className='text-[1rem] font-[outfit] bg-transparent p-3 shadow-blue-900 shadow-sm rounded-[10px_100px/120px_100px] hover:shadow-none hover:bg-blue-900 text-[var(--light-color)] hover:transition-all hover:translate-y-1 ease-in-out'>
