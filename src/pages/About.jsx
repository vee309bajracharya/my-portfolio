    ...
    <section>
      ...
      <section className="xs:px-5 md:px-12 md:max-w-screen-xl md:py-8 md:my-5 md:mx-auto">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}>
          <a href='/projects' className='text-[1rem] font-[outfit] bg-transparent p-3 shadow-blue-900 shadow-sm rounded-[10px_100px/120px_100px] hover:shadow-none hover:bg-blue-900 text-[var(--light-color)] hover:transition-all hover:translate-y-1 ease-in-out'>
